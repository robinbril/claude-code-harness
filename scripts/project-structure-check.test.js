...
const template = fs.readFileSync(path.join(__dirname, '../templates/github-workflows/project-structure.yml'), 'utf8');
assert.match(template, /node \.harness\/projectstructuur\/tools\/project-structure-check\.js --repo \./);
